...
using UnityStandardAssets.CrossPlatformInput; // for android etc devices
...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
        ...
        else if (_canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump")) { // If canDoubleJump and jump button pressed, then allow the player to jump
            DoJump();
            // disable jump after double jumping since you can only really do it once
